...
server <- function(input, output, session) {
  ...
  shinyjs::onclick("BSBCTaddSeason", shinyjs::toggle(id = "BSBctSeason2", anim = TRUE))
      ...
      fluidRow( 
        ...
        column(4,
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SFmaFH_1_len", label = "Min Length", min = 14, max = 21, value = 17.5, step = .5))),
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SFmaPR_1_len", label = "Min Length", min = 14, max = 21, value = 17.5, step = .5))),
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SFmaSH_1_len", label = "Min Length", min = 14, max = 21, value = 16.5, step = .5))),
               ...
               shinyjs::hidden( div(ID = "SFmaSeason2",
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SFmaFH_2_len", label ="Min Length", min = 14, max = 21, value = 16, step = .5))), 
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SFmaPR_2_len", label ="Min Length", min = 14, max = 21, value = 16, step = .5))), 
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SFmaSH_2_len", label ="Min Length", min = 14, max = 21, value = 16, step = .5)))))),
        ...
        column(4, 
               ...
               shinyjs::hidden( div(ID = "BSBmaSeason2",
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "BSBmaFH_2_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5))),
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "BSBmaPR_2_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5))),
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "BSBmaSH_2_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5)))))),
        ...
        column(4,
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SCUPmaFH_1_len", label = "Min Length", min = 8, max = 12, value = 11, step = .5))),
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SCUPmaFH_2_len", label = "Min Length", min = 8, max = 12, value = 11, step = .5))), 
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SCUPmaPR_1_len", label = "Min Length", min = 8, max = 12, value = 11, step = .5))),
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SCUPmaSH_1_len", label = "Min Length", min = 11, max = 18, value = 9.5, step = .5))),
               ...
               shinyjs::hidden( div(ID = "SCUPmaSeason2",
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SCUPmaFH_3_len", label ="Min Length", min = 8, max = 12, value = 10, step = .5))), 
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SCUPmaPR_2_len", label ="Min Length", min = 8, max = 12, value = 10, step = .5))), 
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SCUPmaSH_2_len", label ="Min Length", min = 8, max = 12, value = 10, step = .5)))))))
    }})
  
  output$SFmaMode <- renderUI({
    if (is.null(input$SF_MA_input_type)) return()
    switch(input$SF_MA_input_type, 
           "All Modes Combined" = div(rlang::exec(sliderInput,inputId = "SFma_seas1", label =" Season 1",
                                                  ...
                                                  !!!date_slider_defaults),
                                      fluidRow(
                                        column(4, numericInput(inputId = "SFma_1_bag", label ="Bag Limit", min = 0, max = 100, value = 5)),
                                        column(6, rlang::exec(sliderInput, inputId= "SFma_1_len", label ="Min Length", min = 14, max = 21, value = 16.5, step = .5)))), 
           "Separated By Mode" = div(rlang::exec(sliderInput,inputId = "SFmaFH_seas1", label ="For Hire  Season 1",
                                                 value=c(as.Date("05-21","%m-%d"),as.Date("09-29","%m-%d")), 
                                                 !!!date_slider_defaults),
                                     fluidRow(
                                       column(4, numericInput(inputId = "SFmaFH_1_bag", label ="Bag Limit", min = 0, max = 100, value = 5)),
                                       column(6, rlang::exec(sliderInput, inputId= "SFmaFH_1_len", label ="Min Length", min = 14, max = 21, value = 16.5, step = .5))),
                                     rlang::exec(sliderInput,inputId = "SFmaPR_seas1", label ="Private  Season 1",
                                                 value=c(as.Date("05-21","%m-%d"),as.Date("09-29","%m-%d")), 
                                                 !!!date_slider_defaults),
                                     fluidRow(
                                       column(4, numericInput(inputId = "SFmaPR_1_bag", label ="Bag Limit", min = 0, max = 100, value = 5)),
                                       column(6, rlang::exec(sliderInput, inputId= "SFmaPR_1_len", label ="Min Length", min = 14, max = 21, value = 16.5, step = .5))),
                                     rlang::exec(sliderInput,inputId = "SFmaSH_seas1", label ="Shore  Season 1",
                                                 value=c(as.Date("05-21","%m-%d"),as.Date("09-29","%m-%d")), 
                                                 !!!date_slider_defaults),
                                     fluidRow(
                                       column(4, numericInput(inputId = "SFmaSH_1_bag", label ="Bag Limit", min = 0, max = 100, value = 5)),
                                       column(6, rlang::exec(sliderInput, inputId= "SFmaSH_1_len", label ="Min Length", min = 14, max = 21, value = 16.5, step = .5)))))
  })
  
  output$BSBmaMode <- renderUI({
    if (is.null(input$BSB_MA_input_type)) return()
    switch(input$BSB_MA_input_type,
           "All Modes Combined" = div(rlang::exec(sliderInput,inputId = "BSBma_seas1", label =" Season 1", 
                                      ...
                                      fluidRow(
                                        ...
                                        column(6, rlang::exec(sliderInput, inputId= "BSBma_1_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5)))),
           "Separated By Mode" = div(rlang::exec(sliderInput,inputId = "BSBmaFH_seas1", label =" For Hire  Season 1", 
                                     ...
                                     fluidRow(
                                       ...
                                       column(6, rlang::exec(sliderInput, inputId= "BSBmaFH_1_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5))),
                                     ...
                                     fluidRow(
                                       ...
                                       column(6, rlang::exec(sliderInput, inputId= "BSBmaPR_1_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5))),
                                     ...
                                     fluidRow(
                                       ...
                                       column(6, rlang::exec(sliderInput, inputId= "BSBmaSH_1_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5)))))
  })
      ...
      fluidRow( 
        ...
        column(4,
               ...
               shinyjs::hidden( div(ID = "SFriSeason2",
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SFriFH_2_len", label ="Min Length", min = 14, max = 21, value = 18, step = .5))), 
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SFriPR_2_len", label ="Min Length", min = 14, max = 21, value = 18, step = .5))), 
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SFriSH_2_len", label ="Min Length", min = 14, max = 21, value = 18, step = .5)))))),
        ...
        column(4, 
               ...
               fluidRow(
                 ...
                 column(6, rlang::exec(sliderInput, inputId= "BSBriFH_1_len", label ="Min Length", min = 11, max =18, value = 16, step = .5))),
               ...
               fluidRow(
                 ...
                 column(6, rlang::exec(sliderInput, inputId= "BSBriFH_2_len", label ="Min Length", min = 11, max = 18, value = 16, step = .5))),
               ...
               fluidRow(
                 ...
                 column(6, rlang::exec(sliderInput, inputId= "BSBriPR_1_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5))),
               ...
               fluidRow(
                 ...
                 column(6, rlang::exec(sliderInput, inputId= "BSBriPR_2_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5))),
               ...
               fluidRow(
                 ...
                 column(6, rlang::exec(sliderInput, inputId= "BSBriSH_1_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5))),
               ...
               fluidRow(
                 ...
                 column(6, rlang::exec(sliderInput, inputId= "BSBriSH_2_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5))),
               ...
               shinyjs::hidden( div(ID = "BSBriSeason2",
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "BSBriFH_3_len", label ="Min Length", min = 11, max = 18, value = 16, step = .5))),
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "BSBriPR_3_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5))),
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "BSBriSH_3_len", label ="Min Length", min = 11, max = 18, value = 16.5, step = .5)))))),
        ...
        column(4,
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SCUPriFH_1_len", label = "Min Length", min = 8, max = 12, value = 11, step = .5))),
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SCUPriFH_2_len", label = "Min Length", min = 8, max = 12, value = 11, step = .5))), 
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SCUPriFH_3_len", label = "Min Length", min = 8, max = 12, value = 11, step = .5))), 
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SCUPriPR_1_len", label = "Min Length", min = 8, max = 12, value = 11, step = .5))),
               ...
               fluidRow(
                 ...
                 column(5, rlang::exec(sliderInput, inputId= "SCUPriSH_1_len", label = "Min Length", min = 8, max = 12, value = 9.5, step = .5))),
               ...
               shinyjs::hidden( div(ID = "SCUPriSeason2",
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SCUPriFH_4_len", label ="Min Length", min = 8, max = 12, value = 10, step = .5))), 
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SCUPriPR_2_len", label ="Min Length", min = 8, max = 12, value = 10, step = .5))), 
                                    ...
                                    fluidRow(
                                      ...
                                      column(6, rlang::exec(sliderInput, inputId= "SCUPriSH_2_len", label ="Min Length", min = 8, max = 12, value = 10, step = .5)))))))
    }})
  
  output$SFriMode <- renderUI({
    if (is.null(input$SF_RI_input_type)) return()
    switch(input$SF_RI_input_type, 
           "All Modes Combined" = div(rlang::exec(sliderInput,inputId = "SFri_seas1", label =" Season 1",
                                      ...
                                      fluidRow(
                                        ...
                                        column(6, rlang::exec(sliderInput, inputId= "SFri_1_len", label ="Min Length", min = 14, max = 21, value = 19, step = .5)))), 
           "Separated By Mode" = div(rlang::exec(sliderInput,inputId = "SFriFH_seas1", label ="For Hire  Season 1",
                                     ...
                                     fluidRow(
                                       ...
                                       column(6, rlang::exec(sliderInput, inputId= "SFriFH_1_len", label ="Min Length", min = 14, max = 21, value = 19, step = .5))),
                                     ...
                                     fluidRow(
                                       ...
                                       column(6, rlang::exec(sliderInput, inputId= "SFriPR_1_len", label ="Min Length", min = 5, max = 25, value = 19, step = .5))),
                                     ...
                                     fluidRow(
                                       ...
                                       column(6, rlang::exec(sliderInput, inputId= "SFriSH_1_len", label ="Min Length", min = 14, max = 21, value = 19, step = .5)))))
  })
  
  # NOTE: CT, NY, NJ, DE, MD, VA, NC renderUI blocks are identical to the
  # original — omitted here for brevity but should be kept in your full file.
  # Only the patterns that needed changing (all_data, Lou_SQ, suspendWhenHidden)
  # are shown in detail above and in the outputs section below.
  output$addCT <- renderUI({ if(any("CT" == input$state)){
    # ... (unchanged from original)
  }})
  output$addNY <- renderUI({ if(any("NY" == input$state)){
    # ... (unchanged from original)
  }})
  output$addNJ <- renderUI({ if(any("NJ" == input$state)){
    # ... (unchanged from original)
  }})
  output$addDE <- renderUI({ if(any("DE" == input$state)){
    # ... (unchanged from original)
  }})
  output$addMD <- renderUI({ if(any("MD" == input$state)){
    # ... (unchanged from original)
  }})
  output$addVA <- renderUI({ if(any("VA" == input$state)){
    # ... (unchanged from original)
  }})
  output$addNC <- renderUI({ if(any("NC" == input$state)){
    # ... (unchanged from original)
  }})
