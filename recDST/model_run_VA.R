################################################################################
################################################################################
# Script:       model_run_VA.R
# Purpose:      Runs the projection model for Virginia under a saved
...
#               filename and regulation object name (va rather than ma,
#               e.g. SFvaFH_seas1_op), and the number of seasons the
...
#               L_W_Conversion.csv,
#               directed_trips_calibration_new_VA.feather,
#               proj_catch_draws_VA_<draw>.feather,
#               proj_year_calendar_adjustments_new_VA.csv,
#               base_outcomes_new_VA_<draw>_<mode>.CSV,
#               n_choice_occasions_new_VA_<mode>_<draw>.feather,
...
set.seed(915)
message("model_run_VA.R: starting Virginia projection for scenario '", Run_Name, "', 100 draws across 34 parallel workers. Expect a long run.")
