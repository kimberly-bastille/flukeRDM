################################################################################
################################################################################
# Script:       model_run_DE.R
# Purpose:      Runs the projection model for Delaware under a saved
...
#               filename and regulation object name (de rather than ma,
#               e.g. SFdeFH_seas1_op), and the number of seasons the
#               state defines - 3 summer flounder seasons, 3 black sea bass, 2 scup. It also has three exists() branches.
...
#               L_W_Conversion.csv,
#               directed_trips_calibration_new_DE.feather,
#               proj_catch_draws_DE_<draw>.feather,
#               proj_year_calendar_adjustments_new_DE.csv,
#               base_outcomes_new_DE_<draw>_<mode>.CSV,
#               n_choice_occasions_new_DE_<mode>_<draw>.feather,
#               calibrated_model_stats_new.rds
# Outputs:      output_DE_<Run_Name>_<timestamp>.csv
...
set.seed(915)
message("model_run_DE.R: starting Delaware projection for scenario '", Run_Name, "', 100 draws across 34 parallel workers. Expect a long run.")
