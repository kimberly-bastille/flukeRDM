################################################################################
################################################################################
# Script:       model_run_MD.R
# Purpose:      Runs the projection model for Maryland under a saved
...
#               filename and regulation object name (md rather than ma,
#               e.g. SFmdFH_seas1_op), and the number of seasons the
...
#               L_W_Conversion.csv,
#               directed_trips_calibration_new_MD.feather,
#               proj_catch_draws_MD_<draw>.feather,
#               proj_year_calendar_adjustments_new_MD.csv,
#               base_outcomes_new_MD_<draw>_<mode>.CSV,
#               n_choice_occasions_new_MD_<mode>_<draw>.feather,
#               calibrated_model_stats_new.rds
# Outputs:      output_MD_<Run_Name>_<timestamp>.csv
...
set.seed(915)
message("model_run_MD.R: starting Maryland projection for scenario '", Run_Name, "', 100 draws across 34 parallel workers. Expect a long run.")
