################################################################################
################################################################################
# Script:       predict_rec_catch_data_read_test2_min_plus2.R
# Purpose:      Sensitivity variant: the mirror image of the min_minus2 file, RAISING
#               each minimum size by 2 inches wherever that species' season
#               is open (bag > 0). Closed seasons are left alone.
...
#   machine (C:\ or E:\), at lines 51, 52 and 114.
################################################################################
################################################################################
