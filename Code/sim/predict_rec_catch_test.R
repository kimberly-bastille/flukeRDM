...
simulate_species_project <- function(catch_dt,
  ...
  zero_dt[, (c(paste0("tot_keep_", sp, "_new"), paste0("tot_rel_", sp, "_new"),
               paste0("tot_keep_", sp, "_util"), paste0("tot_rel_", sp, "_util"),
               paste0("tot_keep_", sp, "_weight_lb_new"), paste0("tot_rel_", sp, "_weight_lb_new"))) :=
            .(0L, 0L, 0L, 0L, 0, 0)]
  ...
  trip_out <- data.table::rbindlist(list(trip_pos, zero_dt), use.names = TRUE, fill = TRUE)
